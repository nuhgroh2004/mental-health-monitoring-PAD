...
<div class="min-h-screen bg-white p-2 sm:p-4 md:p-6 lg:p-8 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 w-full mt-[70px]  lg:mt-[100px]">
        ...
        <div class="flex justify-between">
            <button onclick="window.location='{{ route('mahasiswa.edit-profil') }}'" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex items-center justify-center">
