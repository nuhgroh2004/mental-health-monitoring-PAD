...
<div id="deleteModal" class="aller-dasbor-dosen fixed inset-0 hidden bg-gray-900 bg-opacity-75 items-center justify-center z-50">
    <div class="bg-white p-8 rounded-lg shadow-lg text-center transform transition-all duration-300 ease-in-out max-w-md w-full ml-3 mr-3">
...
<div id="deleteAlert" class="fixed top-20 left-1/2 transform -translate-x-1/2 bg-red-500 text-white text-lg font-bold py-2 px-4 rounded shadow-lg hidden mt-7"
...
<div id="requestPermissionAlert" class="fixed top-20 left-1/2 transform -translate-x-1/2 bg-blue-500 text-white text-lg font-bold py-2 px-4 rounded shadow-lg hidden mt-7"
     x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-full"
     x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-300"
     x-transition:leave-start="opacity-100 transform translate-y-0" x-transition:leave-end="opacity-0 transform translate-y-full">
